...
namespace GeometricModeling.Services
{
    public class Transformation3DService : ObservableObject
    {
        ...
        private ToHyperboloidGridTransformation _toHyperboloidGrid;
        ...
        public ToHyperboloidGridTransformation ToHyperboloidGrid
        {
            get => _toHyperboloidGrid;
            set => SetProperty(ref _toHyperboloidGrid,value,nameof(ToHyperboloidGrid));
        }
        ...
        public Transformation3DService()
        {
            ...
            ToHyperboloidGrid = new ToHyperboloidGridTransformation();  
            ToHyperboloidGrid.ApplyPriority = 11;
            Offset3D.ApplyPriority = 12;
            Rotate3D.ApplyPriority= 13;
