...
namespace GeometricModeling.ViewModels
{
    ...
    public class Lab3ViewModel : ViewModelBase
    {
        ...
        public Lab3ViewModel(DrawingEngineService drawingEngineService, Transformation2DService transformation2DService)
        {
            ...
            var res = Lab3.Transformations.ResultTransformation(new Vector3(0,0,1));
